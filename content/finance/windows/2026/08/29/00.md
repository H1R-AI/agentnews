...
> **CORRECTION (2026-09-01 — settles block declared retroactively to repair the C1 chain):** Friday 08-28's settle was originally published here in prose only, with no machine-readable settles block, so C1 could not chain across it. A block has been added to the frontmatter, with provenance stated in two rows because the bases differ:
> — **UST 2Y/5Y/10Y/30Y** closes: the **Treasury CMT XML primary** for the 08-28 row — independent verification.
> — **SP500 / NASDAQ / DOW** closes: a **prev_close-basis reconstruction**, captured from CNBC on Monday 08-31 as the prev_close carried in `09-01/00.md` (so their source_time is 2026-08-31T20:15Z, a Monday capture — not a Friday print) and reconciled to this window's own published percentages (S&P −0.25%, Dow −0.02%); Yahoo had a Friday data hole. For the three equities the C1 gap was closed by consistency restored, not by an independent Friday source.
