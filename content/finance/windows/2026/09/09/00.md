...
---
## Desk frame
- **Held — the switch stays VINDICATED but goes UNTESTED tonight.** The anchor settled 2Y **4.39 on the CMT, +2bp** vs Friday's 4.37 — INERT with room, not the Friday-style +3bp boundary case. But the equity tape never pushed: no index cleared its bar, so "the anchor responds when pushed" was not on trial today. Note the *direction* — the 2Y rose on an equity-down day, the opposite of a flight-to-quality bid, which fits the hawkish-Fed repricing that drove the session rather than any switch signal.
...
**Watch** — **falsifier SCORED UNTESTABLE**, index leg did-not-fire (Dow 1.297% max excursion, about 0.20pp short), anchor 2Y +2bp INERT; counters STAY 0/0; the pathology-enabling leg keeps showing up while the violent equity session does not · **anchor** — 2Y 4.39 (+2bp), the front rose on an equity-down day = hawkish-Fed repricing, not flight-to-quality · **crude-gold divergence RESOLVED** — supply-not-systemic vindicated (WTI settled about +3.4%, near highs), rates branch refuted (long end flat), 18Z "fading" corrected on the settle · **oil durability still NO** — the long end did not follow (30Y +1bp) · **Astra second session FADED** — SanDisk gave back to flat, Micron −1.6%, Nvidia −2.0%; Korea's HBM names read through at Wednesday's jong-ga (Suri's score) · next US settle Wed 20:00Z, scores Thu 00Z
