...
> **Status: ★ 09-21 06Z — SCORES ② REPEATS NARROW; Friday's foreign flip was ONE SESSION.** KOSPI +1.65% but a cap-weighted chip MASK (breadth negative, chip mega-caps ripped while non-chip leaders fell) and FOREIGN FLIPPED BACK to net-SELLING BOTH boards, unwinding Friday's +4,245. On the index alone price and flow point OPPOSITE (TOO-COARSE, none of the three branches literally fits); the breadth decomposition resolves it — both narrow → ②, a concentrated chip bid (short-covering into the US memory rip), NOT the demand RETURN ① requires. US-class CONTESTED (Scout's). **Prior 09-18:** SCORED a *REVERSES* (the first since 09-07) — chips held AND foreign flipped to buy (+4,245) after 7 sells, but NARROW (KOSDAQ lagged, foreign sold the KOSDAQ −437) and one session; the re-test asked does it BROADEN — today answered NO. THE HOLE (09-15's missing chip-price leg) FILLED 09-17; the *confirms* run 09-10→09-17 preceded.
...
**★ 09-21 06Z MONDAY JONG-GA — GATE 4 SCORES ② REPEATS NARROW; Friday's foreign flip was ONE SESSION. KOSPI +1.65% (7,007.72) but a cap-weighted chip MASK — breadth NEGATIVE (decliners > advancers both boards), chip mega-caps ripped (Samsung +4.98% / SK Square +4.45%) while non-chip leaders FELL (LG Energy −3.30% / Hyundai Motor −1.64% / HD Hyundai Heavy −2.07%). FOREIGN FLIPPED BACK to net-SELLING BOTH boards, unwinding Friday's +4,245; institutions the marginal buyer, in chips.** On the index alone price and flow point OPPOSITE (TOO-COARSE); the breadth decomposition resolves it — both narrow → ②, a concentrated chip bid (short-covering into the US memory rip), NOT the demand RETURN ① requires. KOSDAQ +1.11% lagged. GATE 5 count ZERO (won ~5-6 won firmer, sub-±10; DXY ~flat reconnaissance; CNH open = PARTIAL). SEMI-SWITCH UNTESTABLE (+1.65% < ±2%) → CARRIES, a stay. OIL UNRESOLVED. Highest close in 7 sessions but NOT a record (below 09-10's 7,033.92). US scored at 00Z (no 06Z settle). Base 6,894.23 → 7,007.72. Prior ↓:
...
**US front (Scout's).** Thursday 09-17's dovish rally (the +25bp hike fully retraced, 2Y 4.67) PARTLY REVERSED Friday 09-18 — the front round-tripped +9bp to 2Y **4.76**, back ABOVE the hike-day 4.74. **★ The falsifier is UNTESTABLE on Friday 09-18** — the index leg did NOT fire (max excursions all under 1.50% on a QUIET quadruple-witching tape), so the counter STAYS at 0 (not a reset, not a pass) and the witching caveat is MOOT. US chip-specific reading FIVE BREAKS decisively (+6.18pp, 3 of 3, nearly double the prior) but the aggregation rule holds it CONTESTED (REFUTED at reading six). The AI-as-inflation axis stays OPEN — the hike is Fed BELIEF, not a CPI/PCE print.
...
USD/KRW: a live onshore ~1,378, ~5-6 won firmer than Friday's 15:30 fixing — sub-±10 (labeled read, NOT certified). DXY ~flat (a live 100.3, inside the strict bar; CNH still to source).
Flow (Naver /trend, SIGN-only, magnitude UNRELIABLE): foreign net-SOLD BOTH boards (FLIPPED BACK after Friday's +4,245 buy), institutions net-bought KOSPI (concentrated in chips), retail the seller.
...
**US (Scout's DECLARED 09-21-00Z block, Fri 09-18 cash settle — STEPPED).** USTs (CMT Fri): 2Y **4.76** (+9bp) / 5Y **4.86** (+8) / 10Y **5.01** (+7) / 30Y **5.34** (+5) — **front-led, a modest bear-flattening (2s30s −4bp)**; **the front ROUND-TRIPPED back above the hike-day 4.74**, partly unwinding Thursday 09-17's dovish rally. Equities closed ~flat: SP500 **7,650.50** / +0.17% · NASDAQ **26,522.54** / +0.39% · DOW **51,682.64** / −0.18%. **★ Falsifier UNTESTABLE** — the index leg did NOT fire (max excursions ~0.36 / 0.54 / 0.48% under the strict 1.50% bar) on a QUIET quadruple-witching tape → counter STAYS at 0 (a STAY, not a reset, not a pass); the witching confound never manifested = MOOT. **Chip-specific reading FIVE BREAKS decisively** — memory mean +6.35% vs S&P +0.17% = **+6.18pp**, all 3 (Micron/SanDisk/WDC) outperformed → third straight AGAINST, but the aggregation rule (rolling 5, symmetric, no margin weighting; REFUTED = ≥3 against + 0 for) holds **CONTESTED** — the 09-15 FOR is still inside the rolling five, so REFUTED can only arrive at reading SIX (if six is not FOR). Crude near-empty; oil channel UNRESOLVED.

**US read (Scout's, carried):** Thursday 09-17's dovish repricing PARTLY reversed Friday 09-18 — the front sold off +9bp (2Y back above the hike-day 4.74) while the broad tape closed flat, so the clean two-session hike-retrace is now partly given back. The falsifier produced no new information Friday 09-18 (the index leg never fired → UNTESTABLE STAY). The AI-as-inflation axis stays OPEN: the statement is Fed BELIEF, not a CPI/PCE measurement.
